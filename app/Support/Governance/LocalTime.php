...
/**
 * Converts between what a manager types into a date-time field (the community's own wall
 * clock) and what is stored (UTC), so a ballot set to close "at 5pm" closes at 5pm there.
 */

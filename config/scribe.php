...
return [
    ...
    'description' => 'Everything a mobile or partner app needs: residents, maintenance, amenities, front desk, finance, governance and community engagement.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => file_get_contents(resource_path('markdown/api-intro.md')),
    ...
    'auth' => [
        ...
        'extra_info' => 'Get a token from <code>POST /api/v1/auth/token</code> with your email, password and a device name, then send it as <code>Authorization: Bearer {token}</code>.',
    ],
    ...
    'strategies' => [
        ...
        // No live calls: examples come from @response annotations and from API resources built
        // with factories inside a transaction that is rolled back.
